...
import time
import nvblox_torch # The new zero-copy wrapper
...
class NvbloxPanoTSDF:
    def __init__(self, voxel_size_m=0.01, max_depth=6.0, face_size=512, device="cuda"):
        ...
        self.mapper = nvblox_torch.Mapper(voxel_size_m=voxel_size_m)
        ...
        self.camera = nvblox_torch.Camera(f, f, c, c, self.face_size, self.face_size)
